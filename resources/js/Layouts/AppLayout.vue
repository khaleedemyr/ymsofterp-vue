...
const menuGroups = [
    ...
    },
    {
        ...
        menus: [
            ...
            { name: () => 'QA2 Categories', icon: 'fa-solid fa-folder-tree', route: '/qa2-categories', code: 'qa2_categories' },
    ...
    },
    {
          ...
          menus: [
            ...
            { name: () => t('sidebar.menus.it_work_report'), icon: 'fa-solid fa-laptop-medical', route: '/it-work-reports', code: 'it_work_report' },
            ...
            { name: () => t('sidebar.menus.onboarding_template'), icon: 'fa-solid fa-list-check', route: '/onboarding-templates', code: 'onboarding_template' },
            { name: () => t('sidebar.menus.employee_onboarding'), icon: 'fa-solid fa-user-plus', route: '/employee-onboarding', code: 'employee_onboarding' },
            ...
            { name: () => t('sidebar.menus.npd_service_calibration'), icon: 'fa-solid fa-concierge-bell', route: '/npd-service-calibration', code: 'npd_service_calibration' },
            { name: () => t('sidebar.menus.npd_service_calibration_report'), icon: 'fa-solid fa-clipboard-list', route: '/report/npd-service-calibration', code: 'npd_service_calibration_report' },
        ...
        },
    {
        ...
        menus: [
            ...
            { name: () => t('sidebar.menus.kpi_evaluations'), icon: 'fa-solid fa-clipboard-check', route: '/kpi-evaluations', code: 'kpi_evaluations' },
           ...
           // { name: () => t('sidebar.menus.struktur_organisasi'), icon: 'fa-solid fa-sitemap', route: '/organization-chart', code: 'organization_chart' },
            ...
            { name: () => t('sidebar.menus.wfh_request'), icon: 'fa-solid fa-house-laptop', route: '/wfh-requests', code: 'wfh_request' },
            { name: () => t('sidebar.menus.one_plus_one'), icon: 'fa-solid fa-minus-circle', route: '/one-plus-one-submissions', code: 'one_plus_one' },
    ...
    },
    {
        ...
        menus: [
            ...
            { name: () => t('sidebar.menus.manual_cs_complaint'), icon: 'fa-solid fa-headset', route: '/manual-cs-complaints', code: 'manual_cs_complaint' },
            ...
            { name: () => t('sidebar.menus.social_performance'), icon: 'fa-solid fa-chart-column', route: '/crm/social-performance', code: 'social_performance' },
