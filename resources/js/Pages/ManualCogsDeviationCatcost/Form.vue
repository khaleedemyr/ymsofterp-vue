            ...
            <table class="min-w-full text-sm border border-gray-200">
              ...
              <tbody>
                ...
                <tr v-for="(row, idx) in form.items" :key="row._key" class="border-t align-top">
                  ...
                  <td class="px-3 py-3">
                    <input v-model="row.cogs_percent" type="number" step="0.0001" class="w-full rounded-lg border-gray-300 text-right text-sm" placeholder="0" />
                  </td>
                  <td class="px-3 py-3">
                  ...
                  <td class="px-3 py-3">
                    <input v-model="row.deviation_percent" type="number" step="0.0001" class="w-full rounded-lg border-gray-300 text-right text-sm" placeholder="0" />
                  </td>
                  <td class="px-3 py-3">
                  ...
                  <td class="px-3 py-3">
                    <input v-model="row.catcost_percent" type="number" step="0.0001" class="w-full rounded-lg border-gray-300 text-right text-sm" placeholder="0" />
                  </td>
