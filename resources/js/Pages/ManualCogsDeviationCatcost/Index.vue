    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-1">Input manual nilai COGS, deviation, dan catcost per outlet per periode</p>
        </div>
        <Link
          :href="route('manual-cogs-deviation-catcost.create')"
            ...
            <tr v-for="row in records.data" :key="row.id" class="border-b hover:bg-gray-50">
              ...
              <td class="px-4 py-3">
                <div class="flex justify-center gap-2">
                  <Link
                    :href="route('manual-cogs-deviation-catcost.show', row.id)"
                  ...
                  <Link
                    :href="route('manual-cogs-deviation-catcost.edit', row.id)"
...
function applyFilters() {
  router.get(route('manual-cogs-deviation-catcost.index'), {
...
async function confirmDelete(row) {
  ...
  router.delete(route('manual-cogs-deviation-catcost.destroy', row.id))
}
</script>
