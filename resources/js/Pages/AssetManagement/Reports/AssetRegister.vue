      ...
      <div class="mb-6 flex justify-between items-center">
        <div>
          <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
            <i class="fa-solid fa-list text-blue-500"></i> Asset Register Report
          </h1>
          <p class="text-gray-600 mt-1">Daftar lengkap semua asset</p>
        </div>
...
function applyFilters() {
  router.get('/asset-management/reports/asset-register', {
...
function exportReport() {
  ...
  window.open(`/asset-management/reports/asset-register?${params.toString()}`, '_blank');
}
