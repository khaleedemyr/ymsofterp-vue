    ...
    <div class="max-w-4xl w-full mx-auto py-8 px-2">
      <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
          <i class="fa-solid fa-calendar-plus text-blue-500"></i> Tambah Maintenance Schedule
        </h1>
      </div>
      ...
      <form @submit.prevent="submit" class="bg-white rounded-xl shadow-lg p-6 space-y-6">
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
          <Link
            href="/asset-management/maintenance-schedules"
...
function submit() {
  form.post('/asset-management/maintenance-schedules', {
    preserveScroll: true,
  });
}
</script>
