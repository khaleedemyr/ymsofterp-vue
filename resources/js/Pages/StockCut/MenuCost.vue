        ...
        <div class="bg-green-50 rounded-xl p-4 md:p-6 border border-green-200">
          <div class="flex items-center">
            ...
            <div class="ml-4 flex-1">
              ...
              <p class="text-2xl md:text-3xl font-bold text-green-900">Rp {{ formatNumber(summary.total_cost) }}</p>
            </div>
          </div>
        </div>
        
        <!-- Row 3: Total Revenue -->
        <div class="bg-orange-50 rounded-xl p-4 md:p-6 border border-orange-200">
          <div class="flex items-center">
            ...
            <div class="ml-4 flex-1">
              ...
              <p class="text-2xl md:text-3xl font-bold text-orange-900">Rp {{ formatNumber(summary.total_revenue) }}</p>
            </div>
          </div>
        </div>
        
        <!-- Row 4: Total Profit -->
        <div class="bg-emerald-50 rounded-xl p-4 md:p-6 border border-emerald-200">
          <div class="flex items-center">
            ...
            <div class="ml-4 flex-1">
              ...
              <p class="text-2xl md:text-3xl font-bold text-emerald-900">Rp {{ formatNumber(summary.total_profit) }}</p>
            </div>
          </div>
        </div>
