<template>
  <AppLayout title="Preview Template Sertifikat">
    <template #header>
          ...
          <div class="p-6">
            ...
            <div class="max-w-4xl mx-auto">
              <div class="relative bg-white border-2 border-gray-300 shadow-lg overflow-hidden" 
                ...
                <!-- Background Image -->
                <img v-if="template.background_image" 
...
const getTemplatePosition = (field) => {
  return props.template?.text_positions?.[field] || null
}
