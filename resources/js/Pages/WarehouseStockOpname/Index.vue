    ...
    <div class="w-full py-8 px-4">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
          <i class="fa-solid fa-clipboard-check text-blue-500"></i> Warehouse Stock Opname
        </h1>
        <Link
          :href="route('warehouse-stock-opnames.create')"
        ...
        >
          <i class="fa-solid fa-plus mr-2"></i> Buat Warehouse Stock Opname Baru
        </Link>
      </div>
...
function applyFilters() {
  router.get(route('warehouse-stock-opnames.index'), filters.value, {
    preserveState: true,
    preserveScroll: true,
  });
}
