...
function submit() {
  ...
  router.post('/qa-parameters', form.value, {
    onSuccess: () => {
...
<template>
  <AppLayout title="Tambah QA Parameter">
      ...
      <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-6">
          ...
          <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
            <i class="fa-solid fa-plus text-blue-500"></i> Tambah QA Parameter Baru
          </h1>
        </div>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div>
              <label for="kode_parameter" class="block text-sm font-medium text-gray-700 mb-2">
                Kode Parameter <span class="text-green-500">(Auto Generated)</span>
              </label>
              <input
                id="kode_parameter"
              ...
              <div class="mt-1 text-sm text-green-600">
                ...
                Kode parameter akan di-generate otomatis
              </div>
