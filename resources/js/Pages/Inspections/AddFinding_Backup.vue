...
<template>
  <AppLayout title="Add Finding">
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <!-- Point Display -->
            <div v-if="selectedParameterDetail" class="bg-green-50 border border-green-200 rounded-xl p-4">
    ...
    <div v-if="existingInspections && existingInspections.length > 0" class="mt-6">
      <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6">
        <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-4 flex items-center">
          ...
          <span class="hidden sm:inline">Other Inspections in This Outlet & Department</span>
          <span class="sm:hidden">Other Inspections</span>
        </h3>
        ...
        <div class="space-y-4">
          <div 
            ...
            :class="[
              'border rounded-xl p-3 sm:p-4 hover:shadow-md transition',
          ...
          >
            ...
            <div class="block sm:hidden">
              <div class="flex items-start justify-between mb-3">
                <div class="flex-1 min-w-0">
                  <h4 class="font-semibold text-gray-800 text-sm leading-tight">
                    ...
                    <span v-if="otherInspection.id === inspection.id" class="text-blue-600 text-xs">(Current)</span>
                  </h4>
                ...
                <div class="flex items-center gap-2 ml-2">
                  <button
                    ...
                    class="px-2 py-1 bg-green-500 hover:bg-green-600 text-white rounded text-xs transition"
                  >
              ...
              <div class="flex items-center gap-2 mb-3">
                <div v-if="otherInspection.created_by_user?.image" class="w-5 h-5 rounded-full overflow-hidden cursor-pointer hover:scale-110 transition-transform" @click="openUserImage(`/storage/${otherInspection.created_by_user.image}`, otherInspection.created_by_user.nama_lengkap)">
                  <img 
                ...
                <span class="text-xs font-medium text-gray-700">{{ otherInspection.created_by_user?.nama_lengkap || 'Unknown' }}</span>
              </div>
            ...
            <div v-if="otherInspection.details && otherInspection.details.length > 0" class="block sm:hidden mt-3 pt-3 border-t border-gray-200">
              <h5 class="text-xs font-semibold text-gray-700 mb-2">Findings:</h5>
              <div class="space-y-3">
                <div 
                ...
                >
                  ...
                  <div class="text-xs text-gray-600 space-y-1">
                    ...
                    <div>
                      <strong>Detail:</strong> {{ detail.parameter?.kode_parameter }} - {{ detail.parameter?.parameter }}
                    </div>
                    <div v-if="detail.notes">
                      <strong>Notes:</strong> {{ detail.notes }}
                    </div>
                    
                    <!-- Photo Evidence Mobile -->
                    <div v-if="detail.photo_paths && detail.photo_paths.length > 0" class="mt-2">
                      ...
                      <div class="flex gap-1 mt-1">
                        <img 
                          ...
                          class="w-8 h-8 object-cover rounded cursor-pointer hover:opacity-80 transition"
            ...
            <!-- Inspection Details - Desktop -->
            <div v-if="otherInspection.details && otherInspection.details.length > 0" class="hidden sm:block mt-3 pt-3 border-t border-gray-200">
