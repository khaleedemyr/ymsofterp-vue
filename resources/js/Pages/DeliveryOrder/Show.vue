        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div class="mb-2">
              ...
              <span v-if="order.scan_mode === 'mixed'" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-indigo-100 text-indigo-800">
                <i class="fa-solid fa-layer-group mr-1"></i> Mixed (Barcode + Seri)
              </span>
              <span v-else-if="order.scan_mode === 'serial'" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold bg-purple-100 text-purple-800">
          ...
          <table class="w-full min-w-full divide-y divide-gray-200">
            ...
            <tbody>
              ...
              <template v-for="(item, idx) in items" :key="item.id">
                ...
                <tr v-if="item.serial_list && item.serial_list.length" class="bg-purple-50">
                  <td></td>
