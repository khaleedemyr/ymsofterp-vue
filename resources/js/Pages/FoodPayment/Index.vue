      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
          <div class="flex justify-between items-center mb-6">
            <h3 class="text-lg font-medium">Daftar Food Payment</h3>
            <Link
          ...
          <div class="flex gap-3 mb-4">
            <input
              ...
              @input="onSearchInput"
              type="text"
              placeholder="Cari nomor Food Payment..."
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="p in payments" :key="p.id">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-center">
                    <button @click="goToDetail(p.id)" class="text-green-500 hover:text-green-700 mr-2" title="Detail">
                      <i class="fa fa-eye"></i>
                    </button>
                    <button @click="goToEdit(p.id)" class="text-blue-500 hover:text-blue-700 mr-2" title="Edit">
                      <i class="fa fa-pencil-alt"></i>
                    </button>
                    <button @click="confirmDelete(p.id)" class="text-red-500 hover:text-red-700" title="Hapus">
...
function debouncedSearch() {
  router.get('/food-payments', { search: search.value, status: selectedStatus.value }, { preserveState: true, replace: true });
}
