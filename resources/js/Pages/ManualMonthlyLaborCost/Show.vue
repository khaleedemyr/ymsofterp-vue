        ...
        <table class="min-w-full text-sm">
          <thead class="bg-gray-800 text-white">
            <tr>
              ...
              <th class="px-4 py-3 text-right">Nilai Labor Cost</th>
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-3 text-right">{{ formatNumber(item.labor_cost_value) }}</td>
              <td class="px-4 py-3 text-right">{{ formatPercent(item.labor_cost_percent) }}</td>
            </tr>
          </tbody>
        </table>
      </div>
