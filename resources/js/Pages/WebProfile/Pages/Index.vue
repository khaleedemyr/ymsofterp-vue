...
function handleSearch() {
  router.get('/web-profile/pages', { search: search.value }, {
    preserveState: true,
    replace: true
  });
}
...
<template>
  <AppLayout title="Web Profile - Pages">
    <div class="max-w-7xl mx-auto py-8 px-4">
      ...
      <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="page in props.pages.data" :key="page.id">
      ...
      <!-- Pagination -->
      <div v-if="props.pages.links && props.pages.links.length > 3" class="mt-4 flex justify-center">
        <div class="flex gap-2">
          <Link
            v-for="link in props.pages.links"
            :key="link.label"
            :href="link.url || '#'"
            :class="[
