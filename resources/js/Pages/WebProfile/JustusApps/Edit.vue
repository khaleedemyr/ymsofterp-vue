      ...
      <form class="bg-white rounded-lg shadow p-6 space-y-4" @submit.prevent="submit">
        ...
        <div>
          ...
          <p class="mt-1 max-w-3xl text-xs text-gray-500">
            Justus Nest — blok gambar: desktop ±setengah lebar, tinggi 340px (md) / 380px (lg); mobile 260px tinggi, lebar penuh; crop dari tengah.
            Disarankan landscape min. 1600×900 atau 1920×1080; fokus di tengah. JPG/PNG/WEBP, maks. 5 MB (batas upload).
          </p>
