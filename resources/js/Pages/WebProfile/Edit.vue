...
function submit() {
  ...
  router.put(`/web-profile/${props.page.id}`, form.value, {
    preserveScroll: true,
    onSuccess: () => {
      Swal.fire('Berhasil!', 'Page berhasil diperbarui.', 'success');
    },
    onError: (validationErrors) => {
      errors.value = validationErrors;
      isSubmitting.value = false;
      Swal.fire('Error!', 'Gagal memperbarui page. Silakan periksa form yang diisi.', 'error');
    },
    onFinish: () => {
      isSubmitting.value = false;
    }
...
<template>
  <AppLayout title="Edit Web Profile Page">
