    ...
    <div class="print-container">
        ...
        @foreach($purchaseOrders as $index => $po)
            ...
            <div class="po-section">
                ...
                <!-- Budget Information -->
                @if($po->purchase_requisition && $po->purchase_requisition->budget_info)
                    <div style="background-color: #fff3cd; padding: 10px; margin: 10px 0; border-left: 4px solid #ffc107; border-radius: 3px;">
                        <h4 style="margin: 0 0 8px 0; color: #856404; font-size: 14px; font-weight: bold;">
                        ...
                        @elseif($remainingAmount < ($totalBudget * 0.1))
                            <div style="margin-top: 8px; padding: 5px; background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 3px; color: #856404; font-size: 10px;">
