...
<head>
    <meta charset="utf-8">
    <title>Warehouse Detail Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>JUSTUS GROUP</h1>
        <h2>Warehouse Detail Report - {{ $customer }}</h2>
        ...
        <div class="section">
            ...
            <table>
                <thead>
                    <tr>
                        <th>Item</th>
                        <th class="text-right">Qty (S/M/L)</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="qty-breakdown">
                                @if($item->qty_small > 0)
                                <div>S: {{ number_format($item->qty_small, 2) }}</div>
                                @endif
                                @if($item->qty_medium > 0)
                                <div>M: {{ number_format($item->qty_medium, 2) }}</div>
                                @endif
                                @if($item->qty_large > 0)
                                <div>L: {{ number_format($item->qty_large, 2) }}</div>
                                @endif
                            </div>
                        </td>
                    ...
                    <tr class="total-row">
                        ...
                        <td class="text-right"><strong>{{ number_format(collect($items)->sum('total'), 0) }}</strong></td>
                        <td colspan="2"></td>
                    </tr>
                </tbody>
            </table>
