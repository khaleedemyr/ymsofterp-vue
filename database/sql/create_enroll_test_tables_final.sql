-- Create Enroll Test Tables
-- Jalankan query ini untuk membuat tabel yang dibutuhkan untuk sistem enroll test

-- 1. Tabel enroll_tests
CREATE TABLE IF NOT EXISTS `enroll_tests` (
    ...
    `outlet_id` BIGINT UNSIGNED NOT NULL COMMENT 'ID outlet/lokasi test',
    ...
    `expired_at` DATE NULL COMMENT 'Tanggal expired test',
...
CREATE TABLE IF NOT EXISTS `test_results` (
    ...
    `question_order` JSON NULL COMMENT 'Urutan soal yang diacak untuk user ini',
    `current_question_index` INT UNSIGNED DEFAULT 0 COMMENT 'Index soal saat ini',
