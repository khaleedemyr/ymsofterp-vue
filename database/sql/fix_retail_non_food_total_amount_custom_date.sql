-- Fix Retail Non Food Total Amount untuk Tanggal Tertentu
-- Ganti '2025-11-15' dengan tanggal yang ingin diperbaiki

SET @target_date = '2025-11-15'; -- GANTI TANGGAL INI
...
WHERE DATE(rnf.transaction_date) = @target_date
...
-- 2. Update total_amount untuk tanggal tertentu (hanya yang berbeda)
