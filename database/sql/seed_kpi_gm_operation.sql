...
('KPI14',  'QA Compliance & SOP Implementation',           'hybrid', 'outlet',   'percent', 'QA audit score per Regional Area (Bar/Service/Kitchen)',  '>= 90%',          'higher_better', 'monthly',   'D016',                    1, 'A', NOW(), NOW()),
