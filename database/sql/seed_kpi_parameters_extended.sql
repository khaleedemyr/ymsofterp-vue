...
('KPI29', 'Beverage Complaint Ratio',                 'erp',    'outlet',   'percent', 'Beverage/bar complaints vs all CVCC complaints', '<= 0.50%',            'lower_better',  'monthly',   'D040 / D055 * 100',             1, 'A', NOW(), NOW()),
('KPI30', 'Kitchen / Food Complaint Ratio',           'erp',    'outlet',   'percent', 'Kitchen/food complaints vs all CVCC complaints',  '<= 0.50%',            'lower_better',  'monthly',   'D042 / D055 * 100',             1, 'A', NOW(), NOW()),
