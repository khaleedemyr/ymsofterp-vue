-- Fix Retail Non Food Total Amount untuk Semua Data
-- HATI-HATI: Query ini akan update semua data, bukan hanya hari ini
-- Gunakan hanya jika perlu memperbaiki semua data
...
ORDER BY rnf.transaction_date DESC, rnf.created_at DESC;

-- 2. Update total_amount untuk semua data (hanya yang berbeda)
