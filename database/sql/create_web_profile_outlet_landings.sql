...
CREATE TABLE IF NOT EXISTS `web_profile_outlet_landings` (
    ...
    `outlet_subtitle` VARCHAR(255) NULL COMMENT 'Deprecated — nama diambil dari tbl_data_outlet.nama_outlet',
    `headline` VARCHAR(500) NULL,
    `intro_paragraph` TEXT NULL,
    `secondary_paragraph` TEXT NULL,
    `hero_image` VARCHAR(500) NULL,
    `gallery_images` JSON NULL COMMENT 'Deprecated — galeri diambil dari member_apps_brand_galleries',
