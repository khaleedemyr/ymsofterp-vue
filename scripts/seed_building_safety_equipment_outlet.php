...
$template = [
    ...
    'version' => 1,
    'status' => 'A',
    'notes' => 'Seed from Building, Safety, Equipment Outlet audit form screenshots.',
];
...
$parameters = [
    ...
    ['sc' => 'BSEOUT-S2-4', 'code' => 'BSEOUT-2.4.1', 'text' => 'Program preventive maintenance tersedia dan dilaksanakan sesuai jadwal untuk menjaga keandalan dan umur pakai equipment. Guide Line: jadwal PMT tersedia, PMT dilaksanakan sesuai frekuensi, tersedia checklist PMT, bukti pekerjaan terdokumentasi.', 'weight' => 30, 'sort_order' => 10],
    ...
    ['sc' => 'BSEOUT-S2-6', 'code' => 'BSEOUT-2.6.1', 'text' => 'Seluruh kejadian kerusakan equipment dicatat, dianalisis, dan ditindaklanjuti untuk mencegah terjadinya gangguan berulang. Guide Line: logbook kerusakan tersedia, terdapat work order perbaikan, analisa akar masalah dilakukan, waktu penyelesaian perbaikan dimonitor.', 'weight' => 30, 'sort_order' => 10],
    ['sc' => 'BSEOUT-S2-7', 'code' => 'BSEOUT-2.7.1', 'text' => 'Dilakukan evaluasi berkala terhadap umur ekonomis dan tingkat keandalan equipment sebagai dasar pengambilan keputusan peremajaan (replacement). Guide Line: data usia equipment tersedia, riwayat kerusakan terdokumentasi, biaya perbaikan dibandingkan dengan nilai investasi baru, equipment dengan breakdown berulang diusulkan untuk penggantian, tersedia daftar prioritas replacement.', 'weight' => 10, 'sort_order' => 10],
    ['sc' => 'BSEOUT-S2-8', 'code' => 'BSEOUT-2.8.1', 'text' => 'Dilakukan kajian kapasitas operasional secara berkala untuk memastikan jumlah dan jenis equipment sesuai dengan kebutuhan bisnis. Guide Line: kecukupan kapasitas produksi, volume transaksi dibanding kapasitas equipment, bottleneck operasional, penambahan menu atau konsep baru, pertumbuhan penjualan, utilisasi equipment saat peak hours, tersedia usulan CAPEX penambahan equipment.', 'weight' => 10, 'sort_order' => 10],
    ['sc' => 'BSEOUT-S2-9', 'code' => 'BSEOUT-2.9.1', 'text' => 'Equipment yang memerlukan kalibrasi dilakukan verifikasi atau kalibrasi secara berkala untuk memastikan akurasi hasil pengukuran. Guide Line: thermometer terkalibrasi, temperature probe diverifikasi, bukti kalibrasi tersedia, label kalibrasi terpasang.', 'weight' => 10, 'sort_order' => 10],
    ['sc' => 'BSEOUT-S2-10', 'code' => 'BSEOUT-2.10.1', 'text' => 'Setiap equipment memiliki identitas aset dan dokumentasi yang lengkap sebagai dasar pengendalian dan pengambilan keputusan. Guide Line: kode aset tersedia, data spesifikasi equipment tersedia, tanggal pembelian tercatat, warranty terdokumentasi, manual book tersedia, riwayat PMT dan perbaikan terdokumentasi.', 'weight' => 10, 'sort_order' => 10],
];
