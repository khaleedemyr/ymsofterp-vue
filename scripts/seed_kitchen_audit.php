...
$template = [
    ...
    'version' => 1,
    'status' => 'A',
    'notes' => 'Seed from Kitchen Audits template screenshots (updated Jun 2026)',
];
...
$subcategories = [
    ...
    ['cat' => 'KTA-C2', 'code' => 'KTA-S2-5', 'name' => 'DISHWASHER', 'sort_order' => 50],
    ['cat' => 'KTA-C2', 'code' => 'KTA-S2-6', 'name' => 'KITCHEN EQUIPMENT', 'sort_order' => 60],
    ['cat' => 'KTA-C2', 'code' => 'KTA-S2-7', 'name' => 'UTENSIL', 'sort_order' => 70],
    ['cat' => 'KTA-C2', 'code' => 'KTA-S2-8', 'name' => 'SERVING EQUIPMENT', 'sort_order' => 80],
    ['cat' => 'KTA-C2', 'code' => 'KTA-S2-9', 'name' => 'KITCHEN AREA CLEANLINESS', 'sort_order' => 90],
    ['cat' => 'KTA-C2', 'code' => 'KTA-S2-10', 'name' => 'PROSEDUR CLEANING & SANITASI', 'sort_order' => 100],
    ['cat' => 'KTA-C2', 'code' => 'KTA-S2-11', 'name' => 'CUCI TANGAN', 'sort_order' => 110],
...
$parameters = [
    ...
    ['sc' => 'KTA-S1-1', 'code' => 'KTA-1.1.3', 'text' => 'Produk yang diterima atau dibeli secara retail sesuai dengan SPS produk yang telah ditetapkan oleh perusahaan. (SOP-OPS-005)', 'weight' => 10, 'sort_order' => 30],
    ...
    ['sc' => 'KTA-S1-1', 'code' => 'KTA-1.1.7', 'text' => 'Seluruh data telusur (traceability) produk tersedia dan terdokumentasikan dengan lengkap meliputi bukti pembelian dari supplier serta dokumen penerimaan barang (DO) dari head office. (SOP-OPS-002)', 'weight' => 10, 'sort_order' => 70],

    // 1.2 STORAGE
    ['sc' => 'KTA-S1-2', 'code' => 'KTA-1.2.1', 'text' => 'Produk disimpan sesuai standar suhu berdasarkan jenis produk. Sebelum disimpan, seluruh produk harus dipastikan memiliki kondisi kemasan yang bersih, utuh, tidak rusak, tidak bocor, dan produk harus dalam kondisi layak, tidak mengalami kerusakan, pembusukan (spoiled), perubahan warna, perubahan aroma, perubahan tekstur atau indikasi penurunan mutu lainnya. (SOP-QA-002, SOP-QA-004)', 'weight' => 30, 'sort_order' => 10],
    ['sc' => 'KTA-S1-2', 'code' => 'KTA-1.2.2', 'text' => 'Penyimpanan produk harus dipisahkan berdasarkan kategori jenis produk, seperti seafood, beef, poultry, fish, sauce, dairy product, roti, bahan setengah jadi, buah dan sayuran untuk mencegah terjadinya kontaminasi silang. Apabila terdapat keterbatasan ruang/tempat penyimpanan, produk dapat disimpan dalam area yang sama dengan menggunakan box container tertutup. (SOP-QA-014)', 'weight' => 30, 'sort_order' => 20],
    ...
    ['sc' => 'KTA-S1-2', 'code' => 'KTA-1.2.9', 'text' => 'Seluruh pencatatan administrasi harus terdokumentasi dengan lengkap, benar, dan diperbaharui setiap hari, meliputi proses request order (erp), dokumen delivery order (DO), daily inventory, serta data penjualan, guna memastikan ketertelurusan, keakuratan stock, dan pengendalian operasional. (SOP-OPS-001, SOP-OPS-002, SOP-OPS-003)', 'weight' => 10, 'sort_order' => 90],
    ...
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.4', 'text' => 'Tidak terdapat potensi kontaminasi silang yang bukan peruntukannya, tidak menyebabkan perubahan secara organoleptik (warna, aroma, rasa, tekstur). (SOP-QA-015)', 'weight' => 10, 'sort_order' => 40],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.5', 'text' => 'Tidak terdapat potensi kontaminasi silang yang dapat mempengaruhi keamanan pangan, termasuk bahaya kimia, bahaya fisik, maupun kondisi kebersihan produk. Produk harus disimpan dan ditangani dalam kondisi bersih, bebas dari benda asing. (SOP-QA-015)', 'weight' => 50, 'sort_order' => 50],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.6', 'text' => 'Penyimpanan produk harus dipisahkan berdasarkan kategori jenis produk, seperti seafood, beef, poultry, fish, sauce, dairy product, roti, bahan setengah jadi, buah dan sayuran untuk mencegah terjadinya kontaminasi silang. Apabila terdapat keterbatasan ruang/tempat penyimpanan, produk dapat disimpan dalam area yang sama dengan menggunakan box container tertutup. (SOP-QA-014)', 'weight' => 30, 'sort_order' => 60],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.7', 'text' => 'Seluruh produk yang telah disiapkan (prepared produk) serta item dalam kemasan yang telah dibuka wajib memiliki label identifikasi yang lengkap dan jelas. Mencantumkan nama item/produk, tanggal preparation, jam preparation serta tanggal kadaluwarsa atau batas penggunaan (shelf life) sesuai ketentuan perusahaan. (SOP-QA-017, SL-01/K/QA/IX/25)', 'weight' => 30, 'sort_order' => 70],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.8', 'text' => 'Seluruh produk di persiapkan sesuai dengan SOP, instruksi kerja (IK), ketentuan shelf life, dan spesifikasi produk yang telah ditetapkan, serta menerapkan prinsip prinsip keamanan pangan (food safety selama proses preparation). (SOP-OPS-004, SOP-QA-003, SOP-QA-016)', 'weight' => 50, 'sort_order' => 80],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.9', 'text' => 'Tidak menggunakan peralatan yang sama untuk menangani produk mentah dan produk matang/siap saji guna mencegah terjadinya kontaminasi silang. Peralatan seperti pisau, chopping board dan peralatan pendukung lainnya harus digunakan sesuai dengan peruntukannya serta dibedakan berdasarkan kode warna yang telah ditetapkan oleh perusahaan. (SOP-QA-015, STD-QA-008, STD-QA-010). Guide Line: Standar penggunaan cutting board dan pisau: 1. Merah: Daging merah (beef, lamb dan sejenisnya). 2. Kuning: Unggas (poultry). 3. Biru: Seafood dan ikan. 4. Hijau: Sayuran dan buah buahan. 5. Putih: Makanan siap saji. 6. Coklat: Makanan matang.', 'weight' => 30, 'sort_order' => 90],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.10', 'text' => 'Proses thawing produk beku harus dilakukan sesuai dengan metode yang telah ditetapkan untuk menjamin keamanan pangan dan untuk menjaga kualitas produk. (SOP-QA-021). Guide Line: Metode thawing: 1. Thawing chiller pada suhu 1-4°C. 2. Thawing defrost menggunakan microwave. 3. Sousvide. 4. Menggunakan air bersih dan mengalir (ayam dan seafood - Urgent).', 'weight' => 30, 'sort_order' => 100],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.11', 'text' => 'Minyak goreng yang digunakan dipantau kualitasnya serta diganti sebelum mengalami perubahan warna menjadi hitam pekat atau menunjukan tanda tanda penurunan kualitas. (SOP-QA-012)', 'weight' => 30, 'sort_order' => 110],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.12', 'text' => 'Peralatan pengendali suhu panas (bain marie, fryer, oven, microwave) berfungsi dengan baik, serta pengaturan temperatur dan waktu telah disesuaikan dengan standar yang ditetapkan. (SOP-QA-013). Guide Line: Suhu: 1. Bain marie: 60°C - 70°C. 2. Fryer: 300°F. 3. Oven: 200°C (on display).', 'weight' => 30, 'sort_order' => 120],
    ['sc' => 'KTA-S1-3', 'code' => 'KTA-1.3.13', 'text' => 'Utensil yang digunakan untuk proses persiapan produk (preparation) dalam kondisi bersih, terawat dan layak pakai, serta bebas dari kotoran, karat, retak, pecah, atau kerusakan lainnya yang dapat mencemari produk pangan. (SOP-QA-007)', 'weight' => 30, 'sort_order' => 130],

    // 1.4 PROCESSING
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.1', 'text' => 'Tidak terdapat penyimpangan terhadap standar kualitas produk yang telah ditetapkan. Produk harus berada dalam kondisi layak konsumsi, tidak mengalami kerusakan, pembusukan (spoiled), perubahan warna, perubahan aroma, perubahan tekstur atau indikasi penurunan mutu lainnya. (SOP-QA-008, SOP-QA-010, SOP-QA-020)', 'weight' => 50, 'sort_order' => 10],
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.2', 'text' => 'Tidak ditemukan product yang telah melewati tanggal kadaluwarsa (expired). Bahan baku, bahan proses, atau produk yang telah expired, rusak, mengalami penurunan mutu atau tidak sesuai dengan SPS harus segera dipisahkan dari produk yang masih layak digunakan serta diberi label identifikasi yang jelas. (SOP-QA-017, SOP-QA-020, SOP-OPS-005)', 'weight' => 50, 'sort_order' => 20],
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.3', 'text' => 'Seluruh produk yang digunakan dalam proses pengolahan harus mengikuti ketentuan FIFO dan FEFO. (SOP-QA-001)', 'weight' => 30, 'sort_order' => 30],
    ...
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.5', 'text' => 'Pengolahan produk harus dipisahkan berdasarkan kategori jenis produk, seperti seafood, beef, poultry, ikan, sauce, dairy product, roti, bahan setengah jadi, buah dan sayuran untuk mencegah terjadinya kontaminasi silang. Apabila terdapat keterbatasan ruang/tempat penyimpanan, produk dapat disimpan dalam area yang sama dengan menggunakan box container tertutup. (SOP-QA-014)', 'weight' => 50, 'sort_order' => 50],
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.6', 'text' => 'Seluruh produk di persiapkan sesuai dengan SOP (standar recipe), instruksi kerja (IK), ketentuan shelf life, dan spesifikasi produk yang telah ditetapkan, serta menerapkan prinsip prinsip keamanan pangan (food safety selama proses preparation). (SOP-OPS-004, SOP-QA-003, SOP-QA-016)', 'weight' => 50, 'sort_order' => 60],
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.7', 'text' => 'Tidak menggunakan peralatan yang sama untuk menangani produk mentah dan produk matang/siap saji guna mencegah terjadinya kontaminasi silang. Peralatan seperti pisau, chopping board dan peralatan pendukung lainnya harus digunakan sesuai dengan peruntukannya serta dibedakan berdasarkan kode warna yang telah ditetapkan oleh perusahaan. (SOP-QA-015, STD-QA-008, STD-QA-010). Guide Line: Standar penggunaan cutting board dan pisau: 1. Merah: Daging merah (beef, lamb dan sejenisnya). 2. Kuning: Unggas (poultry). 3. Biru: Seafood dan ikan. 4. Hijau: Sayuran dan buah buahan. 5. Putih: Makanan siap saji. 6. Coklat: Makanan matang.', 'weight' => 50, 'sort_order' => 70],
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.8', 'text' => 'Proses thawing produk beku harus dilakukan sesuai dengan metode yang telah ditetapkan untuk menjamin keamanan pangan dan untuk menjaga kualitas produk. (SOP-QA-021). Guide Line: Metode thawing: 1. Thawing chiller pada suhu 1-4°C. 2. Thawing defrost menggunakan microwave. 3. Sousvide. 4. Menggunakan air bersih dan mengalir (ayam dan seafood).', 'weight' => 50, 'sort_order' => 80],
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.9', 'text' => 'Peralatan pengendali suhu panas (bain marie, fryer, oven, microwave) berfungsi dengan baik, serta pengaturan temperatur dan waktu telah disesuaikan dengan standar yang ditetapkan. (SOP-QA-013). Guide Line: Suhu: 1. Bain marie: 60°C - 70°C. 2. Fryer: 300°F. 3. Oven: 200°C (on display).', 'weight' => 30, 'sort_order' => 90],
    ['sc' => 'KTA-S1-4', 'code' => 'KTA-1.4.10', 'text' => 'Utensil yang digunakan untuk proses pengolahan produk dalam kondisi bersih, terawat dan layak pakai, serta bebas dari kotoran, karat, retak, pecah, atau kerusakan lainnya yang dapat mencemari produk pangan. (SOP-QA-007)', 'weight' => 50, 'sort_order' => 100],
    ...
    ['sc' => 'KTA-S2-2', 'code' => 'KTA-2.2.2-GR', 'text' => 'Sampah dipisahkan sesuai kategorinya (organik, non organik dan B3 apabila ada). Tidak ditemukan pencampuran jenis sampah. (SOP-QA-009)', 'weight' => 30, 'sort_order' => 20],
    ...
    ['sc' => 'KTA-S2-3', 'code' => 'KTA-2.3.1', 'text' => 'Main greasetrap dalam kondisi baik, berfungsi, bersih, terawat, tertutup, tidak bocor, saluran pembuangan lancar. Tersedia jadwal dan ceklis pembersihan main grease trap. (SOP-QA-006)', 'weight' => 50, 'sort_order' => 10],
    ...
    ['sc' => 'KTA-S2-5', 'code' => 'KTA-2.5.1', 'text' => 'Dishwashing machine dalam kondisi bersih dan berfungsi baik (air diganti setiap 2 jam sekali). Tersedia jadwal dan ceklis perawatan dishwashing machine. (SOP-QA-023). Guide Line: Temperatur suhu: 55-65 °C for wash and for rinse 82-86 °C.', 'weight' => 50, 'sort_order' => 10],
    ['sc' => 'KTA-S2-5', 'code' => 'KTA-2.5.2', 'text' => 'Pencucian alat saji secara manual dilakukan sesuai standard yang telah ditetapkan. (SOP-QA-023). Guide Line: 1. Perendaman cutleries didalam wadah khusus berisi detergen (chemical yang sudah ditentukan). 2. Proses pencucian dengan menggunakan detergen (chemical yang sudah ditentukan) dan sponge busa. 3. Proses pembilasan dengan air bersih dan mengalir. 4. Proses sanitasi dengan menggunakan chemical yang sudah ditentukan. 5. Khusus skillet dan hot stone, dilakukan proses treatment oil guna mencegah proses karat dengan menggunakan kuas yang sudah ditentukan.', 'weight' => 50, 'sort_order' => 20],
    ['sc' => 'KTA-S2-5', 'code' => 'KTA-2.5.3', 'text' => 'Tidak terdapat sisa makanan atau minuman yang masuk maupun terbawa ke dalam sink. Seluruh sisa makanan dan minuman harus dibersihkan terlebih dahulu dan dibuang ke tempat sampah sesuai kategorinya sebelum proses pencucian dilakukan. (SOP-QA-023)', 'weight' => 30, 'sort_order' => 30],
    ['sc' => 'KTA-S2-5', 'code' => 'KTA-2.5.4', 'text' => 'Volume air di dalam sink tidak melebihi batas yang telah ditetapkan, yaitu maksimal 3/4 dari kapasitas sink, untuk mencegah luapan air dan menjaga efektifitas proses pencucian. (SOP-QA-023)', 'weight' => 30, 'sort_order' => 40],
    ['sc' => 'KTA-S2-5', 'code' => 'KTA-2.5.5', 'text' => 'Sponge pencucian gelas, piring dan peralatan lainnya harus terpisah sesuai penggunaannya, tidak direndam dalam air sabun, serta dijaga dalam kondisi bersih setelah digunakan. (STD-QA-011). Guide line: 1. Sponge biru digunakan untuk gelas dan cup. 2. Sponge hijau digunakan untuk chinaware and cutleries. 3. Sponge kuning digunakan untuk skillet, hotstone, kitchen utensil dan equipment kitchen.', 'weight' => 50, 'sort_order' => 50],
    ['sc' => 'KTA-S2-5', 'code' => 'KTA-2.5.6', 'text' => 'Hasil pencucian alat saji harus bersih, tidak berkerak, bebas dari sisa makanan dan minuman, noda, serta tidak berbau amis. Verifikasi dilakukan melalui sampling alat saji pada setiap jenis kategori. (SOP-QA-023)', 'weight' => 50, 'sort_order' => 60],

    ['sc' => 'KTA-S2-6', 'code' => 'KTA-2.6.1', 'text' => 'Kitchen operating equipment berada dalam kondisi siap pakai, seluruh fungsi operasional seperti pengaturan suhu, timer, indikator, tombol control dan sistem pengaman bekerja dengan baik tanpa menghambat kelancaran proses produksi. (SOP-QA-004, SOP-QA-013)', 'weight' => 10, 'sort_order' => 10],
    ['sc' => 'KTA-S2-6', 'code' => 'KTA-2.6.2', 'text' => 'Kitchen operating equipment dalam kondisi bersih, terawat, bebas dari kerak, minyak, debu, sisa produk, dan kerusakan. Pembersihan equipment dilakukan secara rutin menggunakan metode cleaning dan sanitasi sesuai prosedur yang ditetapkan untuk memastikan kebersihan dan keamanan pangan. (SOP-QA-006, FRM-QA-002)', 'weight' => 30, 'sort_order' => 20],

    ['sc' => 'KTA-S2-7', 'code' => 'KTA-2.7.1', 'text' => 'Seluruh utensil tersedia sesuai kebutuhan operasional, dalam kondisi bersih, kering, terawat, aman digunakan, serta tidak ditemukan kerusakan seperti retak, pecah, penyok, patah atau berkarat. (SOP-QA-005, SOP-QA-007)', 'weight' => 50, 'sort_order' => 10],
    ['sc' => 'KTA-S2-7', 'code' => 'KTA-2.7.2', 'text' => 'Utensil dibersihkan dengan metode cleaning dan sanitasi sesuai dengan SOP yang berlaku, bebas dari sisa makanan, noda minyak, kerak, bau tidak sedap, serta dikeringkan sebelum digunakan atau disimpan. (SOP-QA-006)', 'weight' => 30, 'sort_order' => 20],
    ['sc' => 'KTA-S2-7', 'code' => 'KTA-2.7.3', 'text' => 'Utensil disimpan dalam kondisi tertata rapi pada area yang telah ditentukan, terlindung dari debu, percikan, hama dan potensi kontaminasi silang. (SOP-QA-006)', 'weight' => 10, 'sort_order' => 30],

    ['sc' => 'KTA-S2-8', 'code' => 'KTA-2.8.1', 'text' => 'Seluruh serving equipment atau alat saji tersedia sesuai standar kebutuhan operasional, lengkap dan siap digunakan untuk mendukung kelancaran pelayanan kepada tamu. (SOP-QA-005)', 'weight' => 30, 'sort_order' => 10],
    ['sc' => 'KTA-S2-8', 'code' => 'KTA-2.8.2', 'text' => 'Serving equipment (alat saji) dalam kondisi bersih, kering, bebas dari noda, sidik jari, sisa produk, kerak, debu, bau tidak sedap, dan telah melalui proses cleaning serta sanitasi sesuai SOP yang berlaku. (SOP-QA-023)', 'weight' => 50, 'sort_order' => 20],
    ['sc' => 'KTA-S2-8', 'code' => 'KTA-2.8.3', 'text' => 'Serving equipment (alat saji) tidak mengalami kerusakan seperti retak, penyok, terkelupas, berkarat, atau perubahan bentuk yang dapat mempengaruhi keamanan dan kualitas pelayanan. (SOP-QA-005)', 'weight' => 50, 'sort_order' => 30],
    ['sc' => 'KTA-S2-8', 'code' => 'KTA-2.8.4', 'text' => 'Serving equipment (alat saji) disimpan dalam kondisi tertata rapi pada area penyimpanan pada area yang telah ditentukan, terlindung dari debu, hama dan potensi kontaminasi silang. (SOP-QA-023)', 'weight' => 10, 'sort_order' => 40],

    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.1', 'text' => 'Lantai area kerja dalam kondisi bersih, kering, tidak licin, bebas dari sisa makanan, tumpahan cairan, minyak, debu, genangan air, dan tidak terdapat kerusakan yang dapat mengganggu keselamatan kerja. (SOP-QA-006, FRM-QA-003)', 'weight' => 50, 'sort_order' => 10],
    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.2', 'text' => 'Dinding area kerja bersih, bebas dari noda, cipratan produk, minyak, debu, jamur, sarang hama, serta dalam kondisi terawat tanpa kerusakan yang berpotensi menjadi sumber kontaminasi. (SOP-QA-006, FRM-QA-003)', 'weight' => 30, 'sort_order' => 20],
    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.3', 'text' => 'Plafon dalam kondisi bersih bebas dari debu, sarang laba-laba, jamur, kebocoran, cat mengelupas atau kerusakan lainnya yang dapat mencemari area produksi. (SOP-QA-006, FRM-QA-003)', 'weight' => 50, 'sort_order' => 30],
    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.4', 'text' => 'Pintu area kerja bersih, berfungsi dengan baik bebas dari kotoran dan kerusakan, serta dapat menutup dengan sempurna untuk mencegah masuknya hama. (SOP-QA-006, FRM-QA-003)', 'weight' => 30, 'sort_order' => 40],
    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.5', 'text' => 'Exhaust hood, filter, dan sistem fresh air dalam kondisi bersih, bebas dari penumpukan minyak, debu, dan kotoran. Berfungsi dengan baik untuk menjaga sirkulasi udara, serta mengurangi panas, asap, dan uap diarea kerja. (SOP-QA-006, FRM-QA-003)', 'weight' => 30, 'sort_order' => 50],
    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.6', 'text' => 'Saluran pembuangan (drainase/gutter) dalam kondisi bersih tidak tersumbat, tidak menimbulkan genangan, bebas dari sisa makanan dan bau tidak sedap serta dilengkapi penutup sesuai standar yang berlaku. (SOP-QA-006, FRM-QA-003)', 'weight' => 50, 'sort_order' => 60],
    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.7', 'text' => 'Lampu diarea kitchen dan area steward memiliki pelindung (cover lamp) dalam kondisi bersih berfungsi dengan baik, memberikan pencahayaan, serta tidak terdapat lampu mati atau pecah diarea kerja. (SOP-QA-006, FRM-QA-003). Guide Line: Standar lux di area produksi (kitchen, bar, steward, store).', 'weight' => 30, 'sort_order' => 70],
    ['sc' => 'KTA-S2-9', 'code' => 'KTA-2.9.8', 'text' => 'Ruangan gas dalam kondisi bersih, rapi, memiliki ventilasi yang memadai, bebas dari barang yang tidak berkaitan dengan operasional gas, tidak terdapat indikasi kebocoran, serta dilengkapi dengan rambu keselamatan dan APAR sesuai ketentuan yang berlaku. (SOP-QA-006, FRM-QA-003)', 'weight' => 30, 'sort_order' => 80],

    ['sc' => 'KTA-S2-10', 'code' => 'KTA-2.10.1', 'text' => 'Tersedia jadwal kegiatan cleaning dan sanitasi yang mencakup frekuensi, area/peralatan yang dibersihkan, PIC, serta dilengkapi dengan checklist atau laporan pelaksanaan yang terdokumentasi dan terverifikasi. (SOP-QA-006, FRM-QA-003)', 'weight' => 30, 'sort_order' => 10],
    ['sc' => 'KTA-S2-10', 'code' => 'KTA-2.10.2', 'text' => 'Tersedia prosedur sanitasi yang terdokumentasi dan mudah diakses oleh karyawan. Implementasi sanitasi dilakukan sesuai SOP, termasuk penggunaan bahan kimia dengan konsentrasi, metode, waktu kontak (contact time), dan frekuensi yang telah ditetapkan. (SOP-QA-006)', 'weight' => 10, 'sort_order' => 20],
    ['sc' => 'KTA-S2-10', 'code' => 'KTA-2.10.3', 'text' => 'Seluruh alat kebersihan dalam kondisi bersih, terawat, berfungsi dengan baik, diberi identifikasi sesuai peruntukannya, serta disimpan dengan rapi pada area yang telah ditentukan untuk mencegah kontaminasi silang. (STD-QA-001)', 'weight' => 30, 'sort_order' => 30],
    ['sc' => 'KTA-S2-10', 'code' => 'KTA-2.10.4', 'text' => 'Cleaning cloth dalam kondisi bersih dan dilakukan pembersihan atau penggantian secara berkala selama operasional. Lap dicuci menggunakan deterjen dan direndam dalam larutan sanitasi sesuai konsentrasi standar pada saat opening, selama operation, dan closing untuk mencegah pertumbuhan mikroorganisme serta kontaminasi silang. (SOP-QA-006). Guide Line: Standar kode warna penggunaan lap: 1. Biru : Digunakan untuk mengelap dan mengeringkan peralatan alat saji. 2. Hijau : Digunakan untuk mengelap atau membersihkan peralatan makanan siap saji. 3. Merah : Digunakan untuk membersihkan peralatan/equipment (bagian luar) (Pemanas). 4. Kuning : Digunakan untuk membersihkan peralatan/equipment (bagian dalam) (Pendingin). 5. Coklat : Digunakan khusus untuk area makanan matang (abouyer).', 'weight' => 50, 'sort_order' => 40],
    ['sc' => 'KTA-S2-10', 'code' => 'KTA-2.10.5', 'text' => 'Buah, sayuran, dan telur dicuci serta disanitasi sebelum digunakan sesuai SOP yang berlaku, menggunakan air mengalir dan/atau larutan sanitasi food grade dengan konsentrasi dan waktu kontak yang ditetapkan untuk mengurangi risiko kontaminasi mikrobiologis. (SOP-QA-025, SOP-QA-024). Guide Line: Chemical, Dilusi, Waktu.', 'weight' => 30, 'sort_order' => 50],

    ['sc' => 'KTA-S2-11', 'code' => 'KTA-2.11.1', 'text' => 'Fasilitas cuci tangan (handwash station) tersedia, mudah diakses, bersih, dan berfungsi dengan baik, dilengkapi dengan air mengalir, sabun cuci tangan, tissue sekali pakai, tempat sampah tertutup, serta poster tata cara cuci tangan. (SOP-QA-026)', 'weight' => 30, 'sort_order' => 10],
    ...
    ['sc' => 'KTA-S3-1', 'code' => 'KTA-3.3', 'text' => 'Seluruh wadah bahan kimia, termasuk wadah transfer atau hasil pengenceran, memiliki identitas yang jelas dan mudah dibaca, minimal mencantumkan nama bahan kimia. (SOP-QA-029)', 'weight' => 30, 'sort_order' => 30],
    ...
    ['sc' => 'KTA-S4-1', 'code' => 'KTA-4.3', 'text' => 'Peralatan pengendalian hama seperti perangkap tikus, insect light trap/fly catcher, glue trap, bait station, dan perangkat monitoring lainnya tersedia sesuai kebutuhan, ditempatkan pada titik yang telah ditentukan, dalam kondisi bersih, berfungsi dengan baik, diberi identifikasi, serta dilakukan pemeriksaan secara berkala dan terdokumentasi. (SOP-QA-018)', 'weight' => 10, 'sort_order' => 30],
    ['sc' => 'KTA-S4-1', 'code' => 'KTA-4.4', 'text' => 'Area operasional dan area sekitar outlet dijaga dalam kondisi bersih, rapi, bebas dari penumpukan barang, sampah, genangan air, sisa makanan, dan sumber daya tarik lainnya yang dapat memicu keberadaan hama. (SOP-QA-006)', 'weight' => 30, 'sort_order' => 40],
    ...
    ['sc' => 'KTA-S5-1', 'code' => 'KTA-5.3', 'text' => 'Karyawan pria tidak diperkenankan berkumis atau berjenggot. Rambut harus bersih, rapi, tidak diwarnai dengan warna yang mencolok/disengaja, tidak melebihi alis mata maupun telinga, serta seluruh rambut tertutup sempurna oleh hair net atau penutup kepala selama berada di area produksi. (STD-QA-013)', 'weight' => 50, 'sort_order' => 30],
    ['sc' => 'KTA-S5-1', 'code' => 'KTA-5.4', 'text' => 'Karyawan tidak menggunakan softlens (cosmetic contact lens), bulu mata palsu/eyelash extension, acne patch yang terlihat atau berpotensi terlepas, kutek, kuku palsu, maupun kosmetik berlebihan yang dapat menjadi sumber kontaminasi. (STD-QA-013)', 'weight' => 50, 'sort_order' => 40],
    ...
    ['sc' => 'KTA-S5-1', 'code' => 'KTA-5.6', 'text' => 'Kuku tangan dipotong pendek, bersih, terawat, serta tidak terdapat kotoran pada sela-sela kuku. (STD-QA-013)', 'weight' => 30, 'sort_order' => 60],
    ...
    ['sc' => 'KTA-S5-1', 'code' => 'KTA-5.12', 'text' => 'Karyawan tidak diperbolehkan mengonsumsi makanan atau minuman sisa tamu untuk menjaga standar higiene, kesehatan, dan profesionalisme kerja. (STD-QA-013)', 'weight' => 50, 'sort_order' => 120],
    ...
    ['sc' => 'KTA-S5-1', 'code' => 'KTA-5.14', 'text' => 'Persediaan hand glove sekali pakai, hair net, dan masker tersedia dalam jumlah yang memadai untuk mendukung operasional serta mudah diakses oleh karyawan pada saat dibutuhkan. (STD-QA-013)', 'weight' => 30, 'sort_order' => 140],
    ['sc' => 'KTA-S5-1', 'code' => 'KTA-5.15', 'text' => 'Fasilitas karyawan seperti loker, rak sepatu, toilet karyawan, mushola, area istirahat, dan fasilitas pendukung lainnya berada dalam kondisi bersih, rapi, terawat, tidak berbau, serta dilakukan pembersihan secara rutin sesuai jadwal yang telah ditetapkan. (STD-QA-006). Guide Line: Lemari loker difungsikan sebagai tempat menyimpan ponsel, tas dan barang pribadi karyawan sebelum bekerja. Didalam loker tidak terdapat: sepatu, rokok, masker, hand gloves, senjata jenis apapun, obat-obatan terlarang. Tidak terdapat barang tidak terpakai, sepatu dalam kondisi tertutup (terbungkus), uniform kerja dan sepatu kerja harus dibawa pulang.', 'weight' => 30, 'sort_order' => 150],
    ['sc' => 'KTA-S5-1', 'code' => 'KTA-5.16', 'text' => 'Karyawan wajib melakukan cuci tangan sesuai SOP menggunakan air mengalir dan sabun pada waktu-waktu kritis, seperti sebelum memulai pekerjaan, setelah menggunakan toilet, setelah menangani bahan mentah, setelah membuang sampah, setelah batuk atau bersin, setelah menyentuh bagian tubuh, dan setiap kali terdapat potensi kontaminasi silang. (STD-QA-026). Guide Line: Standar 6 langkah cuci tangan: 1. Telapak tangan dengan telapak tangan. 2. Punggung tangan. 3. Sela-sela jari. 4. Punggung jari. 5. Ibu jari. 6. Ujung jari dan kuku.', 'weight' => 30, 'sort_order' => 160],

    // 6 EMERGENCY & SAFETY FACILITIES
    ['sc' => 'KTA-S6-1', 'code' => 'KTA-6.1', 'text' => 'Lampu emergency tersedia pada area yang dipersyaratkan, dalam kondisi bersih, berfungsi dengan baik, serta mampu menyala secara otomatis saat terjadi pemadaman listrik. Pemeriksaan dan uji fungsi dilakukan secara berkala serta terdokumentasi. (SOP-QA-006)', 'weight' => 10, 'sort_order' => 10],

    // 7 FOOD AND BEVERAGE QUALITY CHECK UNTUK INTERNAL QA
    ['sc' => 'KTA-S7-1', 'code' => 'KTA-7.1', 'text' => 'Produk makanan dibuat sesuai recipe standard, standard portion, metode pengolahan, disajikan pada suhu yang sesuai dengan standar dan spesifikasi produk yang telah ditetapkan oleh perusahaan. (SOP-OPS-004)', 'weight' => 50, 'sort_order' => 10],
    ...
    ['sc' => 'KTA-S7-1', 'code' => 'KTA-7.3', 'text' => 'Produk bebas dari kontaminasi fisik, kimia, dan biologis, seperti rambut, serpihan benda asing, bau tidak normal, lendir, atau indikasi kerusakan lainnya. (SOP-QA-015)', 'weight' => 50, 'sort_order' => 30],
    ['sc' => 'KTA-S7-1', 'code' => 'KTA-7.4', 'text' => 'Produk disajikan menggunakan serving equipment yang sesuai standar, bersih, tidak rusak, dan mendukung kualitas presentasi produk. (SOP-OPS-004, SOP-QA-005)', 'weight' => 50, 'sort_order' => 40],
    ['sc' => 'KTA-S7-1', 'code' => 'KTA-7.5', 'text' => 'Produk disajikan kepada tamu sesuai standar waktu penyajian (service time) yang ditetapkan tanpa mengurangi kualitas produk. (STD-QA-004)', 'weight' => 30, 'sort_order' => 50],
];
