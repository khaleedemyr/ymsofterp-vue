...
Route::prefix('approval-app')->group(function () {
    ...
    Route::middleware(['approval.app.auth'])->group(function () {
        ...
        Route::get('/warehouse-stock-opnames/create-data', [\App\Http\Controllers\WarehouseStockOpnameController::class, 'apiCreateData']);
        ...
        Route::delete('/warehouse-stock-opnames/{id}', [\App\Http\Controllers\WarehouseStockOpnameController::class, 'destroy'])->where('id', '[0-9]+');
        ...
        Route::get('/tickets/by-outlet', [\App\Http\Controllers\TicketController::class, 'getTicketsByOutlet']);
        ...
        Route::get('/report/item-engineering', [\App\Http\Controllers\Report\EngineeringReportController::class, 'reportItemEngineering']);
        ...
        Route::post('/stock-cut/variance-report/bulk-adjust', [\App\Http\Controllers\StockCutController::class, 'bulkAdjustVariance']);
        Route::post('/stock-cut/variance-report/bulk-rollback-adjust', [\App\Http\Controllers\StockCutController::class, 'bulkRollbackVarianceAdjust']);
        ...
        Route::get('/outlet-internal-use-waste/search-items-with-stock', [\App\Http\Controllers\OutletInternalUseWasteController::class, 'searchItemsWithStock']);
        ...
        Route::get('/contra-bon/form/po-gr-detail', [\App\Http\Controllers\ContraBonController::class, 'getPOGRDetail']);
        Route::get('/contra-bon/form/retail-food', [\App\Http\Controllers\ContraBonController::class, 'getRetailFoodContraBon']);
        Route::get('/contra-bon/form/retail-food-detail/{id}', [\App\Http\Controllers\ContraBonController::class, 'getRetailFoodContraBonDetail']);
        ...
        Route::get('/contra-bon/form/warehouse-retail-food-detail/{id}', [\App\Http\Controllers\ContraBonController::class, 'getWarehouseRetailFoodContraBonDetail']);
        ...
        Route::get('/attendance/correction-form', [\App\Http\Controllers\ScheduleAttendanceCorrectionController::class, 'getMyAttendanceCorrectionForm'])->name('api.approval-app.attendance.correction-form');
        Route::post('/attendance/correction-request', [\App\Http\Controllers\ScheduleAttendanceCorrectionController::class, 'submitMyAttendanceCorrection'])->name('api.approval-app.attendance.correction-request');
        ...
        Route::get('/omnichannel-inbox/poll', [\App\Http\Controllers\OmnichannelInboxController::class, 'pollSnapshot'])->name('api.approval-app.omnichannel-inbox.poll');
        Route::get('/omnichannel-inbox/conversations-more', [\App\Http\Controllers\OmnichannelInboxController::class, 'conversationsMore'])->name('api.approval-app.omnichannel-inbox.conversations-more');
        ...
        Route::get('/home/cvcc-regional-capa-pending', [\App\Http\Controllers\HomeController::class, 'cvccRegionalCapaPending'])->name('api.approval-app.home.cvcc-regional-capa-pending');
...
Route::prefix('pos/sync')->group(function () {
    ...
    Route::get('/self-orders', [PosSyncController::class, 'syncSelfOrders'])->name('api.pos.sync.self-orders');
