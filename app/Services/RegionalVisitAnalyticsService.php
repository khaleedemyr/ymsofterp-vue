...
class RegionalVisitAnalyticsService
{
    ...
    /**
     * Kunjungan = scan IN att_log karyawan regional di outlet tertentu.
     * Outlet ditentukan oleh mesin absensi (att_log.sn = outlet.sn) DAN
     * PIN karyawan terdaftar di outlet tersebut (user_pins.outlet_id).
     *
    ...
    /**
     * Detail kunjungan satu outlet: hanya att_log karyawan regional di outlet ini.
     *
     * @param  array<int>  $userIds
    ...
    /**
     * Query att_log karyawan regional per outlet — sama seperti AttendanceReportController.
     *
     * @param  array<int>  $userIds
     */
