...
class ApprovalController extends Controller
{
    ...
    public function getPendingApprovals(Request $request)
    {
        ...
        // Get pending absent requests where current user is the approver
    ...
    public function getApprovalDetails(Request $request, $id)
    {
        ...
        // Get absent request details
        $approval = DB::table('absent_requests')
            ->join('users', 'absent_requests.user_id', '=', 'users.id')
            ->join('leave_types', 'absent_requests.leave_type_id', '=', 'leave_types.id')
            ->leftJoin('users as approvers', 'absent_requests.approved_by', '=', 'approvers.id')
            ->leftJoin('users as rejectors', 'absent_requests.rejected_by', '=', 'rejectors.id')
            ...
            ->select([
                ...
                'rejectors.nama_lengkap as rejector_name',
        ...
        $formattedApproval = (object)[
            ...
            'user' => (object)[
                ...
                'nama_lengkap' => $approval->user_name,
                'jabatan' => (object)[
                    'nama_jabatan' => $approval->nama_jabatan
                ]
            ],
            'leave_type' => (object)[
                'id' => $approval->leave_type_id,
            ...
            'rejector' => $approval->rejector_name ? (object)[
                'nama_lengkap' => $approval->rejector_name
            ] : null,
            'duration_text' => $this->calculateDuration($approval->date_from, $approval->date_to)
        ];
