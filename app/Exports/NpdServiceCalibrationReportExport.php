...
class NpdServiceCalibrationReportExport implements FromCollection, WithCustomStartCell, WithEvents, WithStyles, ShouldAutoSize
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event): void {
                ...
                $title = sprintf(
                    'NPD Service Calibration Report (%s s/d %s)',
                    $filters['date_from'] ?? '-',
                    $filters['date_to'] ?? '-'
                );
    ...
    private function parameterCodesFromPayload(): array
    {
        ...
        return NpdServiceCalibrationService::PARAMETER_CODES;
    }
