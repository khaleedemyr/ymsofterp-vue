...
class RetailSheet implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
    private $report;
    private $tanggal;
    ...
    public function collection()
    {
        try {
            ...
            // Prepare retail data with totals
            $retailData = [];
            ...
            return collect($retailData);
        } catch (\Exception $e) {
            \Log::error('Retail sheet collection error: ' . $e->getMessage());
            return collect([]);
        }
    }
